...
namespace MyFriends2.Controllers
{
    public class FriendsController : Controller
    {
        ...
        public FriendsController(MyFriends2Context context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Friend.Include(f => f.Images).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,Phone, SetImage")] Friend friend)//, IFormFile SetImage)
        {
            ...
            if (ModelState.IsValid && friend.Images.Any() || true)
            {
                _context.Add(friend);
